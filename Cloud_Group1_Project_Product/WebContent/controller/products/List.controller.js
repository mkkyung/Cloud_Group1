sap.ui.define([
	...
	return Controller.extend("Cloud_Group1_ProjectCloud_Group1_Project.controller.products.List", {
		...
		MainData : function(inputData) {
			...
			if (inputData != null) {
				var url = "/ZTG1_CAT3Set?$filter=Cat1Name eq '" + inputData[0] + "'"
						+ " and Cat2Name eq '" + inputData[1] + "'"
						+ " and Cat3Name eq '" + inputData[2] + "'"
						+ " and Cat3Made eq '" + inputData[3] + "'"
						+ " and Cat3Date eq '" + inputData[4] + "'"
						+ " and Cat3Date eq '" + inputData[5] + "'";
			} else {
