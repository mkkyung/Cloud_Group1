...
//			var aFilterVen = [];
			var aFilterPro = [];
			var sQuery = oEvent.mParameters.selectedItem.mProperties.text;
			if (sQuery) {
//				aFilterVen.push(new Filter("PoVname", FilterOperator.Contains, sQuery));
				aFilterPro.push(new Filter("PoPname", FilterOperator.Contains, sQuery));
			}
